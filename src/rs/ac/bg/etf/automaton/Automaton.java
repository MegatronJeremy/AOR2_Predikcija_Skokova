...
public interface Automaton {
    ...
    static Automaton instance(AutomatonType type) {
        switch (type) {
            case ONEBIT:
                return new Automaton1bit();
            case TWOBITS_TYPE1:
                return new Automaton2bits_1();
            case TWOBITS_TYPE2:
                return new Automaton2bits_2();
            case TWOBITS_TYPE3:
                return new Automaton2bits_3();
            case TWOBITS_TYPE4:
                return new Automaton2bits_4();
            case THREEBITS_TYPE1:
                return new Automaton3bits_1();
        }
        return null;
    }
